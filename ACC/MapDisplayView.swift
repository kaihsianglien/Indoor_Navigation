...
class MapDisplayView: UIView {
    fileprivate var pinchScale: CGFloat = 1
    //private var gridLayer: GridLayer
    fileprivate var pathLayer: PathLayer
...
func toZeroPointFiveMultiples(_ x: CGFloat) -> CGFloat { // decrease 'x' to the closest *.5  ex: 1.73 -> 1.5, 3.21 -> 3.0, 0.33 -> 0
